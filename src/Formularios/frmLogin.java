...
public class frmLogin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        cmdlogin.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/accept.png"))); // NOI18N
    ...
    private void cmdloginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdloginActionPerformed
        ...
        menu.setPerfil(clsdados.getPerfil(txtusuario.getText()));
        menu.setSenha(new String(txtsenha.getPassword()));
        menu.setUsuario(new String(txtusuario.getText()));
